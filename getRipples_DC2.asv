...
ripple = filtereeg2_DC(tmpDat, ripplefilter.kernel, smoothing_kernel_rip);
ripple.descript = ripplefilter.descript;
ripple.kernel = ripplefilter.kernel;
ripple.samprate = ripplefilter.samprate;

%actually detect ripples - gonna make/update extractripples3 rather then
%retype it all. just need to remove directory info and point to correct
%data
