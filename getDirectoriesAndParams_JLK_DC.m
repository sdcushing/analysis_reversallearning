...
params.ripple.nstdEnv = 3;%number of standard deviations above mean of envelope for 150-250Hz to detect ripple (Josh has options for 2 values)
...
params.rewrite.filtered = 0;
params.rewrite.ripplesettings = 1;
