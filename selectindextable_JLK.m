...
newtrackcol = strrep(newtrackcol, 'lick', "5");
...
newsessiontypecol = strrep(newsessiontypecol, 'baseline', "4"); %find baseline track for DC
newsessiontypecol = strrep(newsessiontypecol, 'lick', "5"); %find lick track for DC
