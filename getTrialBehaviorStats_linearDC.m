function [rawDataByTrial, statsByRewardTrial, statsByRewardSession] = getTrialBehaviorStats_linearDC(rawDataBySession, virmen_fileInfo, params, saveBehaviorPath)
