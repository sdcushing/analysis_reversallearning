function [] = rawpos_default_DC(index, vrDataFolder, anprocesseddatadir, params)
...
syncedArray = triggerNonperiodicSync_DC(index, vrDataFolder, anprocesseddatadir);
...
if isfield(saveDatCopy, 'dataHeaders')
    ...
    rawpos = struct(...
        ...
        'currentDeg',virmenStruct(iStart:iEnd,find(strcmp(dataHeaders, 'theta'))),...   
...
save([anprocesseddatadir,'rawpos',num2str(index)],'rawpos');
end
